...
(function () {
  ...
  ------------------------------------------------------- */
  function isLoggedIn() {
    try { return localStorage.getItem('nv_logged_in') === '1'; }
    catch (e) { return false; }
  }
  window.AuthState = {
    isLoggedIn: isLoggedIn,
    login: function () { try { localStorage.setItem('nv_logged_in', '1'); } catch (e) {} },
    logout: function () { try { localStorage.removeItem('nv_logged_in'); } catch (e) {} }
  };
  ...
  function initLogoutLinks() {
    document.querySelectorAll('a[href*="logout"], a[data-action="logout"]').forEach(function (a) {
      ...
      a.addEventListener('click', function (e) {
        e.preventDefault();
        try { localStorage.removeItem('nv_logged_in'); } catch (er) {}
